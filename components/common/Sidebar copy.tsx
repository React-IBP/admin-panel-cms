...
//sm:hidden
    const BottonHandleMenu = (classTop = '', open = false) => {
        return (
            <button onClick={handleMenu} data-drawer-target="default-sidebar" data-drawer-toggle="default-sidebar" aria-controls="default-sidebar" type="button" className={`inline-flex items-center p-2 ${classTop} ms-3 text-sm text-gray-500 rounded-lg  hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600`}>
    ...
    return (
        ...
        sessionHandle ? (< div className='relative' >
            {BottonHandleMenu('mt-6')}

            <div id="default-sidebar" ref={sidebarRef} className={`fixed top-0 left-0 z-40 w-64 h-screen transition-transform  ${openSidebar}`
            } aria-label="Sidebar" >
