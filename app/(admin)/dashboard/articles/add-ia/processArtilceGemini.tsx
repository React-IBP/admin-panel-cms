...
const promptContent2 = `
{
  "prompt": {
    "instructions": [
	 "Título Impactante: Usa palabras clave llamativas y emojis para generar curiosidad.",
     ...
     "Navega en la web para enrriquecer la noticia",
...
`;
	...
	try {
        ...
        fetch(process.env.GEMINI_API_KEY, {
            method: 'POST',
            headers: {
