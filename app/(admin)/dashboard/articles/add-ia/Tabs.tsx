        ...
        <>
            <div className="border-b border-gray-200 dark:border-gray-700">
                <ul className="flex flex-wrap -mb-px text-sm font-medium text-center text-gray-500 dark:text-gray-400">
                	<li className="me-2" onClick={() => setActiveTab('tabUrl')}>
                        <span className={`cursor-pointer inline-flex items-center justify-center p-4 border-b-2 ${activeTab === 'tabUrl' ? 'text-blue-600 border-blue-600' : 'border-transparent'} rounded-t-lg dark:hover:text-gray-300`}>
